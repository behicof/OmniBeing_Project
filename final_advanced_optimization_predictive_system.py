...
class FinalAdvancedOptimizationPredictiveSystem:
    def __init__(self):
        ...
        self.gb_model = GradientBoostingClassifier(n_estimators=200)
    ...
    def evaluate_model_accuracy(self):
        # ارزیابی دقت مدل‌ها با استفاده از classification report
        X = np.array(self.market_data)
        y = np.array(self.labels)
